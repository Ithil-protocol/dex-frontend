// Generated by @wagmi/cli@0.1.14 on 4/21/2023 at 12:28:35 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
export const poolABI = [
  ...
  { type: "error", inputs: [], name: "PaidTooHigh" },
  { type: "error", inputs: [], name: "PriceTooHigh" },
  { type: "error", inputs: [], name: "ReceivedTooLow" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "minReceived", internalType: "uint256", type: "uint256" },
      { name: "maxPaid", internalType: "uint256", type: "uint256" },
      { name: "deadline", internalType: "uint256", type: "uint256" },
    ],
    name: "fulfillOrder",
    outputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "actualPrice", internalType: "uint256", type: "uint256" },
    ],
  },
  {
    stateMutability: "view",
