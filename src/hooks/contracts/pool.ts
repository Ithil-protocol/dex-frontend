// Generated by @wagmi/cli@0.1.14 on 4/1/2023 at 4:07:31 PM
import {
  UseContractConfig,
 ...
 */
export function usePool(config: Omit<UseContractConfig, "abi">) {
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link poolABI}__ and `functionName` set to `"orders"`.
 */
export function usePoolOrders<
  TSelectData = ReadContractResult<typeof poolABI, "orders">
>(
  config: Omit<
    UseContractReadConfig<typeof poolABI, "orders", TSelectData>,
    "abi" | "functionName"
  >
) {
  return useContractRead({
    ...
    functionName: "orders",
    ...config,
  } as UseContractReadConfig<typeof poolABI, "orders", TSelectData>);
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link poolABI}__ and `functionName` set to `"priceLevels"`.
 */
export function usePoolPriceLevels<
  TSelectData = ReadContractResult<typeof poolABI, "priceLevels">
>(
  config: Omit<
    UseContractReadConfig<typeof poolABI, "priceLevels", TSelectData>,
    "abi" | "functionName"
  >
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof poolABI, "priceLevels", TSelectData>);
}
...
export function usePoolEvent<TEventName extends string>(
  config: Omit<UseContractEventConfig<typeof poolABI, TEventName>, "abi">
) {
